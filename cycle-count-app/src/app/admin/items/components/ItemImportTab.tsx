...
export default function ItemImportTab({
  file,
  isUploading,
  importResult,
  error,
    ...
    <div className="space-y-8">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-lg">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-lg font-medium text-blue-900">Item Import Requirements</h3>
            <div className="mt-3 text-sm text-blue-800">
              <p className="mb-2">Your Excel file must contain the following columns (exact spelling required):</p>
              <ul className="list-disc list-inside space-y-1">
                <li><code className="bg-blue-100 px-1 rounded">ID</code> - Item ID (number)</li>
                <li><code className="bg-blue-100 px-1 rounded">PartNo</code> - Part number (required)</li>
                <li><code className="bg-blue-100 px-1 rounded">Description</code> - Item description (required)</li>
                <li><code className="bg-blue-100 px-1 rounded">SerialFlag</code> - Serial flag: Y or N (required)</li>
              </ul>
              <p className="mt-3 text-gray-600">Note: Other columns in your Excel file (Name, ManufacturePartNo, ModelNo, etc.) will be ignored. Only the 4 columns above are imported.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Select an Excel file (.xls, .xlsx) or CSV file (.csv) with item data</p>
          </div>
