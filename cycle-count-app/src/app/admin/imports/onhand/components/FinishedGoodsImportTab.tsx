// ============================================================================
// FINISHED GOODS IMPORT TAB
// ============================================================================

'use client';

import { FinishedGoodsImportResult } from '@/lib/utils/excelImport';
import ImportResultsSection from './ImportResultsSection';

interface FinishedGoodsImportTabProps {
  file: File | null;
  isUploading: boolean;
  importResult: FinishedGoodsImportResult | null;
  error: string | null;
...
export default function FinishedGoodsImportTab({
  file,
  isUploading,
  importResult,
  error,
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 sm:p-6 rounded-r-lg">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-base sm:text-lg font-medium text-blue-900">Finished Goods Import Requirements</h3>
            <div className="mt-2 sm:mt-3 text-xs sm:text-sm text-blue-800">
              ...
              <div className="bg-blue-100 p-2 sm:p-3 rounded font-mono text-xs overflow-x-auto mb-2">
                Part Number | Serial No | Part Location No | Warehouse | Pallet Box No
              </div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>Part Location will be extracted after the first dot (e.g., "BOMFix.ARB.H0.0.0" → "ARB.H0.0.0", "DISCREPANCY.SNP.UR.0.0" → "SNP.UR.0.0")</li>
                <li>Pallet Box No is optional</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Upload Finished Goods File</h2>
