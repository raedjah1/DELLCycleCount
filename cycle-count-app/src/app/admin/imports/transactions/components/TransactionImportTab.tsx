...
import { TransactionImportResult } from '@/lib/utils/excelImport';
import ImportResultsSection from './ImportResultsSection';

interface TransactionImportTabProps {
  file: File | null;
  isUploading: boolean;
...
export default function TransactionImportTab({
  file,
  isUploading,
  importResult,
  error,
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 sm:p-6 rounded-r-lg">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-base sm:text-lg font-medium text-blue-900">Transaction Import Requirements</h3>
            <div className="mt-2 sm:mt-3 text-xs sm:text-sm text-blue-800">
              ...
              <div className="bg-blue-100 p-2 sm:p-3 rounded font-mono text-xs overflow-x-auto mb-2">
                PartNo | SerialNo | Qty | Source | PartTransactionType
              </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Upload Transaction File</h2>
